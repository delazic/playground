...
public class PharmacyNetworkConverter {
    ...
    public PharmacyNetwork parseLine(String line) {
        ...
        // Note: network_id and pharmacy_id will be set by DAO
        // We store the string IDs temporarily for reference
        // fields[0] = network_id (will be generated by database)
        // fields[1] = pharmacy_id (will be looked up by DAO)
        ...
        network.setEffectiveDate(parseDate(fields[6]));
        
        // Parse termination date (may be empty)
        network.setTerminationDate(parseDate(fields[7]));
